...
const PrivacyPolicy: React.FC<PrivacyPolicyProps> = ({ content, footerContent }) => {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-4xl font-bold mb-2">{content.privacyPolicy.title}</h1>
        <p className="text-gray-500 text-sm mb-12">{content.privacyPolicy.lastUpdated}</p>
